          ...
          {isDashboard ? (
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent 
                  align="start" 
                  className="w-[360px] p-3 bg-card/90 backdrop-blur-2xl border border-border/40 shadow-2xl rounded-3xl mt-2 font-sans flex flex-col gap-2 animate-in fade-in-50 slide-in-from-top-3 duration-300 relative overflow-hidden"
                >
                  ...
                  <div className="flex flex-col gap-1">
                    {/* Item 1: Community */}
                    <Link href="/community">
                      <DropdownMenuItem className="cursor-pointer rounded-2xl p-3 flex items-start gap-3.5 hover:bg-accent/50 dark:hover:bg-zinc-800/40 focus:bg-accent/60 transition-all duration-300 group border border-transparent hover:border-border/40">
                        <div className="w-9 h-9 rounded-xl bg-purple-500/10 border border-purple-500/20 dark:bg-purple-950/20 dark:border-purple-800/20 flex items-center justify-center shrink-0 shadow-xs group-hover:scale-105 group-hover:bg-purple-500 group-hover:text-white transition-all duration-300">
                          <Users className="w-4.5 h-4.5 text-purple-500 dark:text-purple-400 group-hover:text-white transition-colors" />
                        </div>
                        <div className="space-y-1 min-w-0 flex-1">
                          <div className="text-xs font-bold text-foreground flex items-center justify-between">
                            <span>{t("nav.community")}</span>
                            <ArrowRight className="w-3.5 h-3.5 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 text-purple-500 dark:text-purple-400 transition-all duration-300" />
                          </div>
                    ...
                    <Link href="/docs">
                      <DropdownMenuItem className="cursor-pointer rounded-2xl p-3 flex items-start gap-3.5 hover:bg-accent/50 dark:hover:bg-zinc-800/40 focus:bg-accent/60 transition-all duration-300 group border border-transparent hover:border-border/40">
                        <div className="w-9 h-9 rounded-xl bg-blue-500/10 border border-blue-500/20 dark:bg-blue-950/20 dark:border-blue-800/20 flex items-center justify-center shrink-0 shadow-xs group-hover:scale-105 group-hover:bg-blue-500 group-hover:text-white transition-all duration-300">
                          <BookOpen className="w-4.5 h-4.5 text-blue-500 dark:text-blue-400 group-hover:text-white transition-colors" />
                        </div>
                        <div className="space-y-1 min-w-0 flex-1">
                          <div className="text-xs font-bold text-foreground flex items-center justify-between">
                            <span>{t("nav.docs")}</span>
                            <ArrowRight className="w-3.5 h-3.5 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 text-blue-500 dark:text-blue-400 transition-all duration-300" />
                          </div>
                          <p className="text-[10px] text-muted-foreground leading-snug">
                            {t("nav.docs_desc")}
                          </p>
                    ...
                    {/* Item 3: Help Center */}
                    <Link href="/help">
                      <DropdownMenuItem className="cursor-pointer rounded-xl p-3 flex items-start gap-3.5 hover:bg-accent/50 dark:hover:bg-zinc-800/40 focus:bg-accent/60 transition-all duration-300 group border border-transparent hover:border-border/40">
                        <div className="w-9 h-9 rounded-xl bg-amber-500/10 border border-amber-500/20 dark:bg-amber-950/20 dark:border-amber-800/20 flex items-center justify-center shrink-0 shadow-xs group-hover:scale-105 group-hover:bg-amber-500 group-hover:text-white transition-all duration-300">
                          <HelpCircle className="w-4.5 h-4.5 text-amber-500 dark:text-amber-400 group-hover:text-white transition-colors" />
                        </div>
                        <div className="space-y-1 min-w-0 flex-1">
                          <div className="text-xs font-bold text-foreground flex items-center justify-between">
                            <span>{t("nav.help")}</span>
                            <ArrowRight className="w-3.5 h-3.5 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 text-amber-500 dark:text-amber-400 transition-all duration-300" />
                          </div>
                          <p className="text-[10px] text-muted-foreground leading-snug">
                            {t("nav.help_desc")}
                          </p>
                  ...
                  {/* Dropdown Footer Card */}
                  <div className="mt-1 p-3 rounded-2xl bg-muted/30 border border-border/30 dark:bg-zinc-900/30 flex flex-col gap-2 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-16 h-16 bg-emerald-500/5 blur-lg pointer-events-none rounded-full" />
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-lg bg-emerald-500/10 dark:bg-emerald-950/20 flex items-center justify-center shrink-0">
                        <Mail className="w-3.5 h-3.5 text-emerald-500 dark:text-emerald-400" />
                      </div>
                      <span className="text-[11px] font-bold text-foreground">Direct Support</span>
                    </div>
                    <p className="text-[10px] text-muted-foreground leading-relaxed">
                      Need one-on-one help? Drop us a line or submit a ticket and our Algerian team will get back to you.
                    </p>
                    <a 
                      href="mailto:support@corbit.dz" 
                      className="mt-1 w-full text-center py-1.5 px-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-extrabold uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-1 shadow-md shadow-emerald-600/10 hover:shadow-emerald-500/20 active:scale-98"
                    >
